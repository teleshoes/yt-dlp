...
## DEPENDENCIES
Python versions 3.9+ (3.8hack) (CPython) and 3.11+ (PyPy) are supported. Other versions and implementations may or may not work correctly.
>>>>>>> parent of d78446439 (Remove Python 3.8 support (#11321))
